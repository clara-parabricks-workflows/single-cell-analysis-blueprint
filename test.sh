...
cd /notebooks/single-cell-analysis-blueprint/notebooks
...
jupyter-lab --notebook-dir=/notebooks/single-cell-analysis-blueprint/notebooks --ip=0.0.0.0 --no-browser --NotebookApp.token='' --NotebookApp.allow_origin='*' --allow-root
