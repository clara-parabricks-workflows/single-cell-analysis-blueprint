...
| [06_scRNA_analysis_1.0M_brain_example.ipynb](notebooks/06_scRNA_analysis_1.0M_brain_example.ipynb) | In this notebook, show diversity in capability by run a similar workflow to [01_scRNA_analysis_preprocessing.ipynb](notebooks/01_scRNA_analysis_preprocessing.ipynb), but on brain cells | 24GB /<br>Standard RSC Instance |
